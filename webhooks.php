...
function map_data($text) {
	$arr = array(
		array(
			"text"=>"เปิดอุปกรณ์ 1",
			"similar"=>array("เปิด 1", "เปิดหนึ่ง", "เปิดไฟ 1", "เปิดไฟหนึ่ง"),
			"url"=>"http://kscyber.ddns.net/?D=1&I=1"
		),
		array(
			"text"=>"เปิดอุปกรณ์ 2",
			"similar"=>array("เปิด 2", "เปิดสอง", "เปิดไฟ 2", "เปิดไฟสอง"),
			"url"=>"http://kscyber.ddns.net/?D=2&I=1"
		),
		array(
			"text"=>"เปิดอุปกรณ์ 3",
			"similar"=>array("เปิด 3", "เปิดสาม", "เปิดไฟ 3", "เปิดไฟสาม"),
			"url"=>"http://kscyber.ddns.net/?D=3&I=1"
		),
		array(
			"text"=>"ปิดอุปกรณ์ 1",
			"similar"=>array("ปิด 1", "ปิดหนึ่ง", "ปิดไฟ 1", "ปิดไฟหนึ่ง"),
			"url"=>"http://kscyber.ddns.net/?D=1&I=0"
		),
		array(
			"text"=>"ปิดอุปกรณ์ 2",
			"similar"=>array("ปิด 2", "ปิดสอง", "ปิดไฟ 2", "ปิดไฟสอง"),
			"url"=>"http://kscyber.ddns.net/?D=2&I=0"
		),
		array(
			"text"=>"ปิดอุปกรณ์ 3",
			"similar"=>array("ปิด 3", "ปิดสาม", "ปิดไฟ 3", "ปิดไฟสาม"),
